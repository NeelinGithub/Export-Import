...
export default function RcnRateCalculator({
  commodities,
  ports,
  conditions,
  setConditions,
  ...
  // 4. RCN EXPORT SPECIAL SPECIFICATIONS
  const [rcnOutturn, setRcnOutturn] = useState(() => savedState.rcnOutturn || '48-50');
  const [rcnNutCount, setRcnNutCount] = useState(() => savedState.rcnNutCount || '170-180');
  const [rcnMoisture, setRcnMoisture] = useState(() => savedState.rcnMoisture || '8.0');
  const [rcnDryingCost, setRcnDryingCost] = useState(() => savedState.rcnDryingCost || '0.50');
  const [rcnQualityInspectionCost, setRcnQualityInspectionCost] = useState(() => savedState.rcnQualityInspectionCost || '2.00');
  const [rcnImportExportTrackingId, setRcnImportExportTrackingId] = useState(() => savedState.rcnImportExportTrackingId || 'RCN-TRK-001');
  ...
  if (
    ...
    } else if ((industry as any) === "rcn") {
      primaryOutputLabel = "RCN Landed Selling Price";
      ...
      item = {
        ...
        ...((industry as any) === "rcn"
          ? {
              ...
              rcnMoisture,
              rcnDryingCost,
              rcnQualityInspectionCost,
              rcnImportExportTrackingId
            }
          : {}),
