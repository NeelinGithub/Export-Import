      ...
      <div className="max-w-md w-full bg-slate-950/90 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6">
          ...
          {otpMethod === 'whatsapp' ? (
            ...
            <>
              ...
              <div className="space-y-0.5">
                ...
                <span className="text-xs text-slate-300 font-mono leading-normal block max-w-[240px] truncate">{email || 'your-business@mail.com'}</span>
              </div>
            </>
          )}
        </div>
        ...
        <div className="bg-gradient-to-r from-sky-950/40 to-blue-950/20 border border-sky-800/60 rounded-2xl p-4 text-xs leading-relaxed space-y-2">
          ...
          <div className="text-center pt-1">
            <span className="bg-slate-900/95 border border-sky-600/30 font-mono text-base font-black px-4 py-1.5 rounded-xl text-sky-300 shadow-lg tracking-widest inline-block select-all animate-bounce">
              {demoPin}
            </span>
          </div>
        </div>
        ...
        <form onSubmit={handleVerify} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full bg-slate-900 border border-slate-800 focus:border-sky-500 rounded-xl py-3 text-center text-xl font-mono font-black text-white tracking-widest placeholder-slate-600 transition outline-none"
            />
          </div>
        ...
        <div className="flex justify-between items-center text-[10px] font-bold uppercase tracking-wider text-slate-500">
          ...
          <button
            onClick={onLogout}
            className="text-rose-500 hover:text-rose-400 transition flex items-center gap-1 font-black cursor-pointer uppercase"
          >
