...
export default function RcnQuoteSheet({
  selectedRateIds,
  rateList,
  savedQuotes,
  setSavedQuotes,
                      ...
                      case "commodity":
                        return (
                          <>
                            ...
                            {(industry as any) === "rcn" && row.rcnOutturn && (
                              <div className={`text-[0.85em] ${theme.text} font-extrabold uppercase mt-0.5 space-y-0.5`}>
                                <div>Outturn: {row.rcnOutturn} | Nut Count: {row.rcnNutCount}</div>
                                <div>Moisture: {row.rcnMoisture}% | Trk: {row.rcnImportExportTrackingId}</div>
                              </div>
                            )}
                            {hasBlendDetails && (
                              <div
