...
export default function LandingPage({ onGoToAuth, savedQuotes = [], licenceMetadata }: LandingPageProps) {
  ...
  const DEMO_SHIPMENTS: SavedQuote[] = [
    {
      ...
      buyer: "International Trading Corp",
      buyerLoc: "Doha, Qatar",
      ...
      items: [
        {
          id: 1,
          dest: "Hamad Port, Doha, Qatar",
          commodity: "Premium Export Grade",
    ...
    },
    {
      ...
      trackingUpdates: [
        ...
        },
        {
          ...
          description: "Anchor secured in Hamad Port. Health inspectors verifying Regulatory clearances.",
          emailSent: true
        },
        {
          id: "log-d",
  ...
  const features = [
    {
      ...
      desc: "Instantly convert raw material bulk prices into final FOB/CFR USD value with automated packaging, yield, freight, and custom tax adjustments."
    },
    {
    ...
    {
      icon: Lock,
      title: "Secure Workspace Licencing",
    ...
    },
    {
      ...
      desc: "Add your sales executives, production managers, and shipping assistants. Changes to rates, bag stocks, and clearance documents synchronize across all devices instantly."
    },
    {
      icon: ShieldCheck,
      title: "Customs & Compliance Documentation",
      desc: "Maintain a legally compliant, centralized folder room of all loaded Shipping Bills, official Compliance certificates, and cargo invoices."
    },
    {
      icon: Globe,
  ...
  const pricingPlans = [
    {
      ...
      price: isIndian ? "₹399" : "$5.99",
      period: "per document",
      desc: "Perfect for one-off shipments. Pay as you go.",
      features: [
    ...
    {
      name: "STANDARD PLAN",
      price: isIndian ? "₹2399" : "$29",
      period: "per month",
      desc: "Optimized for new exporters and brokers.",
      features: [
        "720 document sets per month",
        "Unlimited calculator access",
        "2 Collaborative user seats",
    ...
    },
    {
      ...
      price: isIndian ? "₹4899" : "$59",
      period: "per month",
      desc: "Built for midsize teams tracking shipments.",
      features: [
        "2,400 document sets per month",
        "5 Collaborative user seats",
        "Real-Time Firebase Cloud database sync",
        "Full Customs Docs & Shipping Bills",
        "Phyto & Document file lockers"
      ],
    ...
    },
    {
      ...
      price: isIndian ? "₹9899" : "$119",
      period: "per month",
      desc: "Bespoke deployment for high volume globally.",
      features: [
        "7,200 document sets per month",
        "20 Collaborative user seats",
    ...
    {
      name: "ANNUAL PLAN",
      price: isIndian ? "₹44000" : "$599",
      period: "per year",
      desc: "Maximum value for high-volume traders globally.",
      features: [
        "12,000 document sets per year",
        "50 Collaborative user seats",
    ...
    <div className="bg-slate-950 text-slate-100 min-h-screen font-sans selection:bg-blue-600 selection:text-white" id="public-marketing-site">
      ...
      <section className="relative overflow-hidden pt-20 pb-16 lg:pt-32 lg:pb-24 border-b border-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-6">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/25 text-blue-400 text-[10px] font-mono font-bold uppercase tracking-wider mx-auto">
            <Sparkles className="w-3 h-3" /> Fully Integrated Global Exporter CRM
          </div>
          
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black text-white tracking-tight max-w-4xl mx-auto leading-tight drop-shadow-2xl">
            Stop Losing Profit on <span className="bg-gradient-to-r from-emerald-400 via-teal-400 to-cyan-400 bg-clip-text text-transparent drop-shadow-none">Complex Export Math</span>
          </h1>

          <p className="text-slate-400 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed">
            A premium, multi-user workspace for global production facilities and exporters. Calculate complex rate boards with dynamic packaging stocks, generate compliance A4 Proformas, and sync with your shipping assistants instantly.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-4">
            ...
            <button 
              onClick={onGoToAuth}
              className="w-full sm:w-auto px-6 py-3.5 border border-slate-800 hover:border-slate-700 bg-slate-900/60 backdrop-blur-sm text-slate-300 hover:text-white rounded-xl text-xs font-semibold transition flex items-center justify-center gap-1"
            >
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-slate-800/80 pb-5">
                  <div className="space-y-1">
                    ...
                    <p className="text-[11px] text-slate-400 flex items-center gap-1">
                      ...
                      Buyer Representative: <strong className="text-slate-300 font-bold">{trackedQuote.buyer}</strong>
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
                    ...
                    <div className="bg-slate-900 border border-slate-800 p-3 rounded-lg flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <p className="text-[11px] font-bold text-slate-200 uppercase">Regulatory Clearance</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center space-y-3 max-w-2xl mx-auto">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-white uppercase tracking-tight">
              Engineered for Fast-Paced Global Trade
            </h2>
            <p className="text-slate-400 text-xs sm:text-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center space-y-3 max-w-2xl mx-auto">
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-white uppercase tracking-tight mt-3">
              How Global Exporters Streamline Shipments
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center select-none">
            ...
            <div className="bg-slate-900/25 border border-slate-900 p-6 rounded-2xl space-y-3">
              ...
              <p className="text-[11px] text-slate-400 leading-relaxed">
                Your production manager notes packaging completions, and sales files packing lists on our secure dashboard.
              </p>
            </div>
            ...
            <div className="bg-slate-900/25 border border-slate-900 p-6 rounded-2xl space-y-3">
              ...
              <p className="text-[11px] text-slate-400 leading-relaxed">
                Upload raw Regulatory compliance documents, file active Shipping Bills, and compile port dispatch logs.
              </p>
            </div>
      ...
      <section id="pricing" className="py-20 bg-slate-950 px-4 focus:outline-hidden border-b border-slate-900 relative">
        ...
        <div className="max-w-7xl mx-auto space-y-12 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 max-w-[1400px] mx-auto items-stretch">
            {pricingPlans.map((plan, index) => (
              <div 
                key={index}
                className={`flex flex-col justify-between p-6 sm:p-8 rounded-3xl border transition relative ${
                  plan.popular 
                    ? 'bg-slate-900 border-indigo-600 shadow-2xl shadow-indigo-500/5 Ring-2 ring-indigo-500' 
                  ...
                  <button 
                    ...
                    className={`w-full py-3 rounded-xl font-bold text-xs uppercase tracking-wide transition ${
                      plan.popular 
                        ...
                        : 'border border-slate-800 hover:border-slate-700 hover:bg-slate-900 text-slate-300 hover:text-white'
                    }`}
                  >
                    {plan.cta}
                  </button>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-900/30 border border-slate-900 p-5 rounded-2xl space-y-1">
              ...
              <p className="text-xs text-slate-400 leading-relaxed ml-5.5">
                Absolutely. Every facility creates a completely separate workspace identified via a unique Workspace License. Exporter prices, private suppliers, and custom tax percentages are fully encrypted on Firestore. Other clients cannot view your proprietary info.
              </p>
            </div>
            ...
            <div className="bg-slate-900/30 border border-slate-900 p-5 rounded-2xl space-y-1">
              ...
              <p className="text-xs text-slate-400 leading-relaxed ml-5.5">
                Yes! When a sales executive updates the Shipping Bill or a production manager uploads the clearance certificate, the system automatically replicates the document name and state to Cloud Firestore, updating all screen views live for everyone in your team.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 relative overflow-hidden text-center bg-gradient-to-b from-slate-950 to-slate-900">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 relative z-10">
          ...
          <p className="text-slate-400 text-sm max-w-xl mx-auto leading-relaxed">
            Eliminate communication gaps between your sales managers, freight handlers, and production operators. Try the offline-resilient dashboard for free.
          </p>
          <div className="pt-4">
            <button 
              onClick={onGoToAuth}
      ...
      <footer className="border-t border-slate-900 bg-slate-950 py-12 text-center text-xs text-slate-500 font-mono">
        <p>© 2026 Free Export Manager SaaS Corporation. Fully Integrated Global Exporter Platform. Protected by offline TLS & Firestore Security.</p>
        <p className="mt-2 text-[10px] text-slate-600">Handcrafted under compliant port clearance protocol calibrations.</p>
      </footer>
