...
const INITIAL_TRACKS: ShipmentTrack[] = [
  ...
  },
  {
    id: 'TRK-904',
    quoteRef: 'RFQ-NVOCC1',
    companyName: 'NVOCC GLOBAL FORWARDING',
    containerId: 'TBAU2319402',
    sealNo: 'NV-992144',
    vesselName: 'NVOCC CONSOLIDATOR VSL',
    commodity: 'Basmati Rice Premium (Shared Slot)',
    quantityTons: 80,
    originPortKey: 'mundra',
    destPortKey: 'dubai',
    progressPercent: 40,
    statusText: 'Consolidated Cargo - Sea Transit to Jebel Ali',
    temperature: 25.5,
    humidity: 11.0,
    vibration: 0.05,
    etaDays: 4
  ...
  return (
    <div className="space-y-5 animate-in fade-in duration-350">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="bg-slate-950 border border-slate-800 rounded-xl p-3 flex items-center gap-3 shrink-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-1 flex flex-col gap-4">
          <form onSubmit={handleFindContainer} className="bg-white border border-gray-300 rounded-2xl p-4 shadow-xs space-y-3">
            <label className="text-gray-500 font-sans tracking-wide text-xs font-black block uppercase">
          ...
          <div className="bg-white border border-gray-300 rounded-2xl p-4 shadow-xs flex-1 flex flex-col space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-gray-500 font-sans tracking-wide text-xs font-black uppercase">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-1.5 text-[9.5px] font-semibold text-gray-600 font-mono mb-2">
        ...
        <div className="lg:col-span-2 flex flex-col gap-4">
          ...
          {/* MAP CANVAS PANEL */}
          <div className="bg-slate-950 border border-slate-800 rounded-2xl overflow-hidden shadow-xl flex flex-col relative">
            
            {/* Map selection switcher bar */}
            <div className="bg-slate-900 border-b border-slate-800 px-4 py-2.5 flex items-center justify-between no-print select-none">
            ...
            {customKeyWarning && !hasValidMapsKey && (
              <div className="absolute top-12 left-4 right-4 z-50 bg-slate-900 border border-amber-900 text-amber-200 text-[10.5px] p-3 rounded-xl shadow-2xl flex items-start gap-2.5 animate-in slide-in-from-top duration-350">
            ...
            <div className="w-full h-[320px] bg-slate-950 relative flex items-center justify-center">
              ...
              {mapInterface === 'google' && hasValidMapsKey ? (
                ...
                <div className="w-full h-full relative overflow-hidden bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-slate-900 via-slate-950 to-black select-none">
                  ...
                  <div className="absolute top-2 left-3 font-mono text-[8px] text-slate-500 space-y-0.5">
                    <div>RADAR SECTOR: ARABIAN SEA / GULF LINK</div>
                    <div>LAT BOUNDS: 10.00° N - 30.00° N</div>
                  </div>
                  <div className="absolute top-2 right-3 font-mono text-[8px] text-slate-500 text-right">
                  ...
                  <div className="absolute bottom-2.5 left-3 bg-slate-950/90 border border-slate-800 p-1.5 rounded-lg flex gap-2.5 items-center font-mono text-[7px] text-slate-400 select-none">
            ...
            <div className="bg-slate-900 border-t border-slate-800 p-4.5 grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs font-mono select-none">
              ...
              <div className="space-y-1 sm:border-r border-slate-800 sm:pr-2">
                <span className="text-slate-500 block text-[9px] uppercase font-bold tracking-wider flex items-center gap-1 text-slate-400">
          ...
          <div className="bg-white border border-gray-300 rounded-2xl p-5 shadow-xs space-y-4">
            ...
            <div className="bg-slate-50 rounded-xl p-3.5 border border-gray-100 flex items-start gap-3">
